...
\u2514\u2500\u2500 Outputs
    ...
    \u2514\u2500\u2500 Group_B_Rx01_TC01
        \u2514\u2500\u2500 FVSOut_Group_B_Rx01_TC01.db"),
              ...
              tags$ul(
                tags$li(strong("Keyfile generation: "), "Defaults to 8 cores (or all available cores when fewer than 8 are available). Keyfiles are generated in parallel, but adding more workers is likely to increase cluster startup overhead without meaningfully reducing processing time."),
                tags$li(strong("rFVS execution and database merging: "), "Each stage defaults to 75% of the available cores, capped at 40. This reserves system resources while avoiding the performance saturation typically observed beyond 40 workers.")
              ),
